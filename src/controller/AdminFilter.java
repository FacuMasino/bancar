 ...
 * donde se requiera la sesión inicada de un Administrador
 */
...
public class AdminFilter implements Filter 
{
    ...
    {
    	System.out.println("Filtro admin accionado.");
		...
		// Si hay un user guardado en session se obtiene el Rol, 
		// si es Rol Cliente entonces se asigna true
