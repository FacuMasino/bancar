    ...
    <div class="container md:max-w-[800px] mx-auto my-6 px-2">
      ...
      <form method="post" action="AdminClientsServlet?action=newClient"
        ...
        <div class="flex flex-col w-full gap-2">
          ...
          <p>* La contraseña debe contener al menos 1 mayúscula, 1
        ...
        <div class="flex flex-col w-full">
          <div class="form-control w-full">
            <label for="clientAdress" class="label"> <span
              class="label-text font-bold">Domicilio (Número)</span>
            </label>
          </div>
          <input type="text" name="clientStreetNumber"
            placeholder=" Número " class="input input-bordered w-full" />
        </div>
        <!-- Provincia -->
        <div class="flex flex-col w-full gap-2">
          <div class="flex gap-4">
