  ...
  <t:adminwrapper activeMenuItem="adminClientsMenu">
    <div
      ...
      <div class="flex flex-col p-6 bg-white rounded-lg drop-shadow-sm">
        ...
        <div class="flex flex-col w-fit">
          ...
          <div class="flex justify-between gap-2 text-red-600">
            <span class="font-bold">Deuda:(no va por
              enunciado....)</span> <span>$ 10.000</span>
          </div>
          <div class="flex justify-between gap-2 text-blue-600">
            <span class="font-bold">Cantidad de Pr�stamos:</span>
            <c:choose>
          ...
          <c:when test="${not empty client.accounts}">
            <c:forEach var="account" items="${client.accounts}"
              ...
              <div
                ...
                De forma din�mica, ejemplo:
                "openEditModal(<%=accNumber%>,<%=accBalance%>"
                  --%>
                  <button type="button"
                    onclick="openEditModal(1010,10000)"
      ...
      <form method="get" action="#"
        ...
        <button class="btn btn-primary w-fit">Crear cuenta</button>
      </form>
      ...
      <form method="get" action="#" class="modal-box bg-white">
        ...
        <div class="py-4 flex items-center justify-end gap-2.5">
          <span>Saldo:</span> <input id="accountNumberInput"
            type="hidden" name="accountNumber" /> <input
        ...
        <div class="modal-action">
          ...
          <button type="button" onclick="modal_edit_account.close()"
